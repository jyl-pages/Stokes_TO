...
PoissonDownSample3D::PoissonDownSample3D(PoissonDescriptor3D *_f_desr, PoissonDescriptor3D *_c_desr)
{
	f_descr = _f_desr;
	c_descr = _c_desr;
...
PoissonUpSample3D::PoissonUpSample3D(PoissonDescriptor3D *_f_desr, PoissonDescriptor3D *_c_desr)
{
	f_descr = _f_desr;
	c_descr = _c_desr;
