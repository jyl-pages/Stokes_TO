    ...
    : public closure_launcher_base<Closure>
{
    ...
    {
        return cusp::system::cuda::detail::function_attributes(super_t::get_launch_function());
    }
...
function_attributes_t closure_attributes(void)
{
    ...
    {
        return cusp::system::cuda::detail::function_attributes(Launcher::get_launch_function());
    }

    if(!attributes_exist[device_id])
    {
        function_attributes[device_id] = cusp::system::cuda::detail::function_attributes(Launcher::get_launch_function());
