...
struct ImGuiStorage
{
    struct ImguiPair
    {
        ...
        ImguiPair(ImGuiID _key, int _val_i) { key = _key; val_i = _val_i; }
        ImguiPair(ImGuiID _key, float _val_f) { key = _key; val_f = _val_f; }
        ImguiPair(ImGuiID _key, void* _val_p) { key = _key; val_p = _val_p; }
    };
    ImVector<ImguiPair>      Data;
